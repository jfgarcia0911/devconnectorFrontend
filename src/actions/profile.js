...
export const addExperience =
	...
	async (dispatch) => {
		try {
			...
			const body = JSON.stringify(formData);
			const res = await axios.put(process.env.REACT_APP_API_URL + "api/profile/experience", body, config);
...
export const addEducation =
	...
	async (dispatch) => {
		try {
			...
			const body = JSON.stringify(formData);
			const res = await axios.put(process.env.REACT_APP_API_URL + "api/profile/education", body, config);
